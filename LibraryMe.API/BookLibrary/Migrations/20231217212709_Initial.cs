    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BorrowingStatuses", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_VisitorMemberships", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ReservatorId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    VisitorMembershipId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    VisitorAccountId = table.Column<Guid>(type: "uniqueidentifier", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_VisitorsCards", x => x.Id);
                    table.ForeignKey(
                        name: "FK_VisitorsCards_VisitorMemberships_VisitorMembershipId",
                        column: x => x.VisitorMembershipId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ReadersCardId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    BorrowingStatusId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ReadersCardId1 = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Borrowings", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Borrowings_BorrowingStatuses_BorrowingStatusId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Borrowings_BorrowingStatusId",
                table: "Borrowings",
